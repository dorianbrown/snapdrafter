...
import '/screens/deck_viewer.dart';
import '/screens/deck_scanner.dart';
...
class MyDecksOverviewState extends State<MyDecksOverview> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  void initState() {
    ...
    // Checking if deck tutorial needed
